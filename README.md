...
1. **Clonar el repositorio:**
   ```bash
   git clone [https://github.com/VALDIVIEZOatero/FINAL_CALIDAD_DE_SOFTWARE.git](https://github.com/VALDIVIEZOatero/FINAL_CALIDAD_DE_SOFTWARE.git)
...
Localiza la clase principal y presiona Shift + F10 O DARLE CLICK AL BOTÓN DE CORRER
